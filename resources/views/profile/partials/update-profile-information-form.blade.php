<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="user_code" name="user_code" type="text" class="form-control" :value="old('user_code', $user->user_code)" required
                autofocus autocomplete="user_code" />
        ...
        <div>
            ...
            <x-text-input id="gender" name="gender" type="text" class="form-control" :value="old('gender', $user->gender)" required
