                                        ...
                                        @foreach ($categories as $cate)
                                            <li class="widget__categories--menu__list">
                                                <a class="widget__categories--menu__label d-flex align-items-center"
                                                    ...
                                                    <span
                                                        class="widget__categories--menu__text">{{ $cate->name }}</span>
                                                </a>
                                            </li>
                                        @endforeach
                                    </ul>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <form action="{{ route('addCart', $pro_sale->id) }}" method="POST">
                            ...
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="{{ route('shopDetails', $pro_sale->id) }}">
                                        <div class="product__card--thumbnail__container">
                                            <img class="product__card--thumbnail__img @if ($pro_sale->quantity_product == 0) out-of-stock @endif" src="{{ asset('upload/public/images/' . $pro_sale->image) }}" style="height: 200px;" alt="product-img">
                                    ...
                                    <div id="product_grid" class="tab_pane">
                                        <div class="product__section--inner">
                                            <div class="row mb--n30">
                                                @foreach ($products as $pro)
                                                    <form action="{{ route('addCart', $pro->id) }}" method="POST">
                                                        @csrf()
                                                                        ...
                                                                        <li class="product__card--action__list">
                                                                            @if ($pro->favorited)
                                                                                <a class="product__card--action__btn"
                                                                                    ...
                                                                                    <span
                                                                                        class="visually-hidden">Unlove</span>
                                                                                @else
                                                                                    <a class="product__card--action__btn"
                                                                                        title="Love"
                                                                                        href="{{ route('favorite', $pro->id) }}">
                                                                ...
                                                                <div class="product__card--content text-center">
                                                                    ...
                                                                    <div class="product__card--price">
                                                                        @if (isset($pro->price_sale) && $pro->price_sale > 0)
                                                                            ...
                                                                            <span
                                                                                class="old__price">{{ $pro->price }}đ</span>
                                                                        @else
                                                                            <span
...
=======
                                <div class="product__card--content text-center">
                                    <div class="quantity__box">
                                        <!-- <button type="hidden" type="button" class="quantity__value quickview__value--quantity decrease" aria-label="quantity value" value="Decrease Value">-</button> -->
                                        <label>
                                            <input type="hidden" name="quantity" type="number" class="quantity__number quickview__value--number" value="1" data-counter />
                                        </label>
                                        <!-- <button  type="hidden"  type="button" class="quantity__value quickview__value--quantity increase" aria-label="quantity value" value="Increase Value">+</button> -->
                                    </div>
                                    <h3 class="product__card--title text-truncate"><a href="{{ route('shopDetails', $pro_sale->id) }}">{{ $pro_sale->name }}
                                        </a>
                                    </h3>
                                    <div class="product__card--price">
                                        <span class="current__price">{{ $pro_sale->price_sale }}đ</span>
                    ...
                    <div class="shop__sidebar--widget widget__area d-none d-lg-block">
                        <div class="single__widget widget__bg">
                            ...
                            <ul class="widget__categories--menu">
                                @foreach ($categories as $cate)
                                <li class="widget__categories--menu__list">
                                    <a class="widget__categories--menu__label d-flex align-items-center" href="{{ route('fillCate', $cate->id) }}">
                                        <i class="bi bi-brightness-low-fill" style="color: #C97F5F;"></i>
                        ...
                        <div class="single__widget price__filter widget__bg">
                            ...
                            <div class="price-range-wrap">
                                <div class="range-slider">
                                    <form action="{{ route('fillPrice') }}" method="GET">
                                        <p>
                                            <button class="primary__btn price__filter--btn" type="submit">Lọc</button>
                        ...
                        <div class="single__widget widget__bg">
                            ...
                            <div class="shop__sidebar--product">
                                ...
                                <div class="small__product--card d-flex">
                                    ...
                                    <div class="small__product--content">
                                        <h3 class="small__product--card__title"><a href="product-details.html">{{ $pro_new->name }}</a></h3>
                                        <div class="small__product--card__price mb_5">
                                            <span class="current__price">{{ $pro_new->price }}đ</span>
                                        </div>
                                    </div>
                                                ...
                                                <article class="product__card">
                                                    <div class="product__card--thumbnail">
                                                        <a class="product__card--thumbnail__link display-block" href="{{ route('shopDetails', $pro->id) }}">
                                                            <div class="product__card--thumbnail__container">
                                                                <img class="product__card--thumbnail__img @if ($pro->quantity_product == 0) out-of-stock @endif" src="{{ asset('upload/public/images/' . $pro->image) }}" style="height: 200px;" alt="product-img">
                                                    ...
                                                    <div class="product__card--content text-center">
                                                        <h3 class="product__card--title"><a href="{{ route('shopDetails', $pro->id) }}" data-product-id="{{ $pro->id }}">{{ $pro->name }}
                                                            </a></h3>
                                                        <div class="product__card--price">
                                                            @if (isset($pro->price_sale) && $pro->price_sale > 0)
                                                            <span class="current__price">{{ $pro->price_sale }}đ</span>
                                                            <span class="old__price">{{ $pro->price }}đ</span>
                                                            @else
                                                            <span class="current__price">{{ $pro->price }}đ</span>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </article>
                                        ...
                                        <div class="col mb-30">
                                            ...
                                            <form action="{{ route('addCart', $pro->id) }}" method="POST">
                                                ...
                                                <div class="product__card product__list d-flex align-items-center">
                                                    ...
                                                    <div class="product__card--content product__list--content">
                                                        <h3 class="product__card--title"><a href="{{ route('shopDetails', $pro->id) }}" data-product-id="{{ $pro->id }}">{{ $pro->name }}</a>
                                                        </h3>
