                            ...
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="{{route('shopDetails',$pro_sale->id)}}">
                                        <img class="product__card--thumbnail__img product__primary--img" style="height: 200px;" src="{{ asset('storage/images/'.$pro_sale->image) }}" alt="product-img">
                                ...
                                <div class="product__card--content text-center">
                                    ...
                                    <h3 class="product__card--title"><a href="product-details.html">{{$pro_sale->name}} </a></h3>
                            ...
                            <div class="shop__sidebar--product">
                                ...
                                <div class="small__product--card d-flex">
                                    <div class="small__product--thumbnail">
                                        <a class="display-block" href="product-details.html"><img src="{{ asset('storage/images/'.$pro_new->image) }}" style="height: 80px;" alt="product-img"></a>
                                    </div>
