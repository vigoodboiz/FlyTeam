                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="cart__summary border-radius-10">
                                        <form action="{{ route('check_coupon') }}" method="POST">
                                            ...
                                            <div class="coupon__code mb-30">
                                                ...
                                                <p class="coupon__code--desc">Nhập mã phiếu giảm giá của bạn nếu bạn có một.
                                                </p>
                                        ...
                                        <table class="cart__summary--total__table">
                                            <tbody>
                                                ...
                                                <tr class="cart__summary--total__list">
                                                    ...
                                                    <td class="cart__summary--amount text-right">{{ $totalPrice }} VNĐ
                                                    </td>
                                        ...
                                        @foreach (Session::get('coupon') as $key => $cou)
                                            @if ($cou['coupon_condition'] == 1)
                                                ...
                                                <p>
                                                    ...
                                                    echo '<p><li >Giảm :' . number_format($total_coupon, 0, ',', '.') . '</li></p>';
                                                    ?>
                                                </p>
                                                <p>
                                                    <li>Phải trả :
                                            ...
                                            @elseif($cou['coupon_condition'] == 2)
                                                Giảm : {{ number_format($cou['coupon_number'], 0, ',', '.') }}
                                                <p>
                                                    <?php
                                                ...
                                                <p>
                                                    <li>Phải trả : {{ number_format($total_coupon, 0, ',', '.') }}</li>
                                                </p>
                                            @endif
                                        @endforeach
                                    @endif
                                    ...
                                    <div class="cart__summary--footer">
                                        <p class="cart__summary--footer__desc">Vận chuyển & thuế được tính toán khi thanh
                                            toán</p>
                                    ...
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            ...
                                            <div class="product__add--to__card">
                                                <a class="product__card--btn" title="Add To Card" href="cart.html"> Add
                                                    to
                                                    Cart
                                ...
                                <div class="swiper-slide">
                                    <article class="product__card">
                                        ...
                                        <div class="product__card--content text-center">
                                            ...
                                            <h3 class="product__card--title"><a href="product-details.html">Quis nihil
                                                    modi dn
                                                    venia vel ac? </a></h3>
                                            <div class="product__card--price">
                                ...
                                <div class="swiper-slide">
                                    <div class="brang__logo--items">
                                        <img class="brang__logo--img"
                                            src="{{ asset('becute/assets/img/logo/brand-logo1.webp') }}"
                                            alt="brand-logo">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="brang__logo--items">
                                        <img class="brang__logo--img"
                                            src="{{ asset('becute/assets/img/logo/brand-logo2.webp') }}"
                                            alt="brand-logo">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="brang__logo--items">
                                        <img class="brang__logo--img"
                                            src="{{ asset('becute/assets/img/logo/brand-logo3.webp') }}"
                                            alt="brand-logo">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="brang__logo--items">
                                        <img class="brang__logo--img"
                                            src="{{ asset('becute/assets/img/logo/brand-logo4.webp') }}"
                                            alt="brand-logo">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="brang__logo--items">
                                        <img class="brang__logo--img"
                                            src="{{ asset('becute/assets/img/logo/brand-logo5.webp') }}"
                                            alt="brand-logo">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="brang__logo--items">
                                        <img class="brang__logo--img"
                                            src="{{ asset('becute/assets/img/logo/brand-logo6.webp') }}"
                                            alt="brand-logo">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="brang__logo--items">
                                        <img class="brang__logo--img"
                                            src="{{ asset('becute/assets/img/logo/brand-logo7.webp') }}"
                                            alt="brand-logo">
                                    </div>
                                </div>
                            </div>
