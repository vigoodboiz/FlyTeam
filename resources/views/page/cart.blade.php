                            ...
                            <table class="cart__table--inner">
                                ...
                                <tbody class="cart__table--body">
                                    ...
                                    <tr class="cart__table">
                                        <th><img style="height: 80px" ; src="{{ asset('upload/public/images/' . $cart->product->image) }}"></th>
                                        ...
                                        <td class="product-close">
                                            <a href="{{ route('cart.delete', $cart->id) }}" class="product-remove" title="Remove this product">
