                                ...
                                <table class="cart__table--inner">
                                    ...
                                    <tbody class="cart__table--body">
                                        ...
                                        <tr class="cart__table">
                                            <th><img style="height: 80px" ; src="{{ asset('storage/images/'.$cart->product->image) }}"></th>
                                ...
                                @if(Session::get('coupon'))
									@foreach(Session::get('coupon') as $key => $cou)
										@if($cou['coupon_condition']==1)
											...
											<p><li>Must pay : {{number_format($totalPrice-$total_coupon,0,',','.')}}</li></p>
										@elseif($cou['coupon_condition']==2)
											...
											<p><li>Must pay : {{number_format($total_coupon,0,',','.')}}</li></p>
										@endif
									@endforeach
							@endif 
