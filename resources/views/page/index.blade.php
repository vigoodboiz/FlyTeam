...
@section('content')
    <main class="main__content_wrapper">
                        ...
                        <div class="hero__slider--items">
                            ...
                            <div class="hero__slider--layer">
                                <img class="slider__layer--img"
                                    src="{{ asset('becute/assets/img/slider/home1-slider1-layer.png') }}" alt="slider-img">
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="hero__slider--items">
                            ...
                            <div class="hero__slider--layer">
                                <img class="slider__layer--img"
                                    src="{{ asset('becute/assets/img/slider/home1-slider2-layer.png') }}" alt="slider-img">
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="hero__slider--items">
                            ...
                            <div class="hero__slider--layer">
                                <img class="slider__layer--img"
                                    src="{{ asset('becute/assets/img/slider/home1-slider3-layer.png') }}" alt="slider-img">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="image__width--text__section position-relative">
            ...
            <img class="section__shape--img" src="{{ asset('becute/assets/img/other/shape-img1.webp') }}"
                alt="shape-img">
            <img class="section__shape--img two" src="{{ asset('becute/assets/img/other/shape-img2.webp') }}"
                alt="shape-img">
        </section>
                                    ...
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block"
                                                href="{{ route('shopDetails', $pro_trending->id) }}">
                                                <div class="product__card--thumbnail__container">
                                                    <img class="product__card--thumbnail__img @if ($pro_trending->quantity_product <= 0) out-of-stock @endif"
                                                        src="{{ asset('upload/public/images/' . $pro_trending->image) }}"
                                        ...
                                        <div class="product__card--content text-center">
                                            <h3 class="product__card--title text-truncate"><a
                                                    href="{{ route('shopDetails', $pro_trending->id) }}">{{ $pro_trending->name }}</a>
                                            </h3>
        ...
        <section class="video__banner--section position-relative section--padding pb-0">
            <img class="video__banner--section__thumbnail"
                src="{{ asset('becute/assets/img/banner/banner-fullwidth1.webp') }}" alt="img">
                ...
                <div class="container">
                    <div class="video__banner--inner d-flex align-items-end">
                        <div class="video__banner--box position-relative">
                            <img class="video__banner--box__thumbnail"
                                src="{{ asset('becute/assets/img/banner/banner3.webp') }}" alt="banner-img">
                            <div class="bideo__play">

                                <a class="bideo__play--icon glightbox" href="https://youtu.be/khYupez97OU"
                                    data-gallery="video">
                                ...
                                <form action="{{ route('addCart', $new_pro->id) }}" method="POST">
                                    ...
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            ...
                                            <div class="product__add--to__card">
                                                @if ($new_pro->quantity_product > 0)
                                                    <button class="product__card--btn" title="Add To Card"
                                                        type="submit"> Thêm giỏ hàng
                                                        <svg width="17" height="15" viewBox="0 0 14 11"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                                                d="M13.2371 4H11.5261L8.5027 0.460938C8.29176 0.226562 7.9402 0.203125 7.70582 0.390625C7.47145 0.601562 7.44801 0.953125 7.63551 1.1875L10.0496 4H3.46364L5.8777 1.1875C6.0652 0.953125 6.04176 0.601562 5.80739 0.390625C5.57301 0.203125 5.22145 0.226562 5.01051 0.460938L1.98707 4H0.299574C0.135511 4 0.0183239 4.14062 0.0183239 4.28125V4.84375C0.0183239 5.00781 0.135511 5.125 0.299574 5.125H0.721449L1.3777 9.78906C1.44801 10.3516 1.91676 10.75 2.47926 10.75H11.0339C11.5964 10.75 12.0652 10.3516 12.1355 9.78906L12.7918 5.125H13.2371C13.3777 5.125 13.5183 5.00781 13.5183 4.84375V4.28125C13.5183 4.14062 13.3777 4 13.2371 4ZM11.0339 9.625H2.47926L1.86989 5.125H11.6433L11.0339 9.625ZM7.33082 6.4375C7.33082 6.13281 7.07301 5.875 6.76832 5.875C6.4402 5.875 6.20582 6.13281 6.20582 6.4375V8.3125C6.20582 8.64062 6.4402 8.875 6.76832 8.875C7.07301 8.875 7.33082 8.64062 7.33082 8.3125V6.4375ZM9.95582 6.4375C9.95582 6.13281 9.69801 5.875 9.39332 5.875C9.0652 5.875 8.83082 6.13281 8.83082 6.4375V8.3125C8.83082 8.64062 9.0652 8.875 9.39332 8.875C9.69801 8.875 9.95582 8.64062 9.95582 8.3125V6.4375ZM4.70582 6.4375C4.70582 6.13281 4.44801 5.875 4.14332 5.875C3.8152 5.875 3.58082 6.13281 3.58082 6.4375V8.3125C3.58082 8.64062 3.8152 8.875 4.14332 8.875C4.44801 8.875 4.70582 8.64062 4.70582 8.3125V6.4375Z"
            ...
            <div class="container">
                ...
                <div class="product__section--border position-relative">
                    <div class="product__section--countdown d-flex justify-content-center"
                        data-countdown="Sep 30, 2024 00:00:00"></div>
                                ...
                                <div class="swiper-slide">
                                    <form action="{{ route('addCart', $sale_pro->id) }}" method="POST">
                                        ...
                                        <article class="product__card">
                                            <div class="product__card--thumbnail">
                                                <a class="product__card--thumbnail__link display-block"
                                                    href="{{ route('shopDetails', $sale_pro->id) }}">
                                                    <div class="product__card--thumbnail__container">
                                                        <img class="product__card--thumbnail__img @if ($sale_pro->quantity_product <= 0) out-of-stock @endif"
                                                            src="{{ asset('upload/public/images/' . $sale_pro->image) }}"
                                                            style="height: 200px;" alt="product-img">
                                                ...
                                                <ul class="product__card--action">
                                                    ...
                                                    @if (Auth::check())
                                                        <li class="product__card--action__list">
                                                            @if ($sale_pro->favorited)
                                                                <a class="product__card--action__btn" title="Bỏ thích"
                                                                    href="{{ route('favorite', $sale_pro->id) }}">
                                                                    <svg class="product__card--action__btn--svg"
                                                                        width="18" height="18" color="#FF0000"
                                                                        viewBox="0 0 16 13" fill="red"
                                                                        xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="product__card--content text-center">
                                                ...
                                                <h3 class="product__card--title text-truncate"><a
                                                        href="{{ route('shopDetails', $sale_pro->id) }}">{{ $sale_pro->name }}</a>
                                                </h3>
                                                <div class="product__card--price">
        ...
        <section class="banner__fullwidth--section position-relative">
            <img class="banner__fullwidth--bg__thumbnail"
                src="{{ asset('becute/assets/img/banner/banner-fullwidth2.webp') }}" alt="img">
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="testimonial__items">
                                <div class="testimonial__author d-flex align-items-center">
                                    <div class="testimonial__author__thumbnail">
                                        <img src="{{ asset('becute/assets/img/other/testimonial1.webp') }}"
                                            alt="testimonial-img">
                                    </div>
                                ...
                                <div class="testimonial__content">
                                    ...
                                    <img class="testimonial__vector--icon"
                                        src="{{ asset('becute/assets/img/icon/vector-icon.webp') }}" alt="icon">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial__items">
                                <div class="testimonial__author d-flex align-items-center">
                                    <div class="testimonial__author__thumbnail">
                                        <img src="{{ asset('becute/assets/img/other/testimonial2.webp') }}"
                                            alt="testimonial-img">
                                    </div>
                                    <div class="testimonial__author--text">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial__items">
                                <div class="testimonial__author d-flex align-items-center">
                                    <div class="testimonial__author__thumbnail">
                                        <img src="{{ asset('becute/assets/img/other/testimonial3.webp') }}"
                                            alt="testimonial-img">
                                    </div>
                                    <div class="testimonial__author--text">
                                        <h3 class="testimonial__author--title">Michael Linda</h3>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial__items">
                                <div class="testimonial__author d-flex align-items-center">
                                    <div class="testimonial__author__thumbnail">
                                        <img src="{{ asset('becute/assets/img/other/testimonial4.webp') }}"
                                            alt="testimonial-img">
                                    </div>
                                    <div class="testimonial__author--text">
                                        <h3 class="testimonial__author--title">Lee Barners</h3>
