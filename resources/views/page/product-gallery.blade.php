                    ...
                    <div class="col">
                        <div class="product__details--gallery">
                            <div class="row row-cols-2">
                                <div class="col mb-30">
                                    <a class="display-block glightbox" data-gallery="gallery" href="assets/img/product/big-product/product1.webp">
                                        <img src="assets/img/product/big-product/product1.webp" alt="product gallery img">
                                    </a>
                                </div>
                                <div class="col mb-30">
                                    <a class="display-block glightbox" data-gallery="gallery" href="assets/img/product/big-product/product2.webp">
                                        <img src="assets/img/product/big-product/product2.webp" alt="product gallery img">
                                    </a>
                                </div>
                                <div class="col mb-30">
                                    <a class="display-block glightbox" data-gallery="gallery" href="assets/img/product/big-product/product3.webp">
                                        <img src="assets/img/product/big-product/product3.webp" alt="product gallery img">
                                    </a>
                                </div>
                                <div class="col mb-30">
                                    <a class="display-block glightbox" data-gallery="gallery" href="assets/img/product/big-product/product4.webp">
                                        <img src="assets/img/product/big-product/product4.webp" alt="product gallery img">
                                    </a>
                                </div>
                            </div>
                        </div>
