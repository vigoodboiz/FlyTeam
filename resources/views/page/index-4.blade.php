...
<main class="main__content_wrapper">
            ...
            <div class="row mb--n30">
                <div class="col-lg-8 col-md-8 mb-30">
                    <div class="banner__box border-radius-5 position-relative">
                        <a class="display-block" href="shop.html"><img class="banner__box--thumbnail banner_sm_height-250 border-radius-5" src="assets/img/banner/banner18.webp" alt="banner-img">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 custom-col mb-30">
                    <div class="banner__box border-radius-5 position-relative">
                        <a class="display-block" href="shop.html"><img class="banner__box--thumbnail border-radius-5" src="assets/img/banner/banner19.webp" alt="banner-img">
                            <div class="banner__box--content__style top">
                                <h3 class="banner__box--content__style--subtitle">Best Offer</h3>
                                <h2 class="banner__box--content__style--title ">Gemstone <br>
                                    Cuff Bangle</h2>
                                <span class="banner__box--content__style--btn primary__btn">SHOP NOW </span>
                            </div>
                        </a>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 custom-col mb-30">
                    <div class="banner__box border-radius-5 position-relative">
                        <a class="display-block" href="shop.html"><img class="banner__box--thumbnail border-radius-5" src="assets/img/banner/banner20.webp" alt="banner-img">
                            <div class="banner__box--content__style top">
                                <h3 class="banner__box--content__style--subtitle">Best Offer</h3>
                                <h2 class="banner__box--content__style--title ">Ribbon <br>
                                    bracelet</h2>
                                <span class="banner__box--content__style--btn primary__btn">SHOP NOW </span>
                            </div>
                        </a>
                ...
                <div class="col-lg-8 col-md-8 mb-30">
                    <div class="banner__box border-radius-5 position-relative">
                        <a class="display-block" href="shop.html"><img class="banner__box--thumbnail banner_sm_height-250 border-radius-5" src="assets/img/banner/banner21.webp" alt="banner-img">
                            <div class="banner__box--content__style middle">
                                <h3 class="banner__box--content__style--subtitle">Flat 30% Off On Fruits</h3>
                                <h2 class="banner__box--content__style--title ">Bracelet with Matt <br>
                                    silver magnetic clasp</h2>
                                <span class="banner__box--content__style--btn primary__btn">SHOP NOW </span>
                            </div>
                        </a>
                    </div>
    ...
    <div class="grid__banner--section section--padding pt-0">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="grid__banner--left__sidebar">
                        <div class="grid__banner--thumbnail position-relative">
                            <img src="assets/img/banner/banner22.webp" alt="banner-img">
                            <div class="lookbook__box grid__banner__lookbook">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="grid__banner--content__style2">
                        <h2 class="grid__banner--title">Curated By Color</h2>
                        <p class="grid__banner--desc">Brighten up your look with vibrant gemstone jewelry.</p>
                        <a class="grid__banner--btn primary__btn" href="shop.html">SHOP NOW</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="shop__collection--section section--padding pt-0">
        <div class="container">
            <div class="section__heading text-center mb-40">
                <h2 class="section__heading--maintitle">TOP CATEGORIES</h2>
            </div>
            <div class="shop__collection--column5 swiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="shop__collection--card position-relative text-center">
                            <a class="shop__collection--link" href="shop.html">
                                <img class="shop__collection--img m-0" src="assets/img/collection/collection7.webp" alt="icon-img">
                                <h3 class="shop__collection--title__style mb-0">Necklaces</h3>
                            </a>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="shop__collection--card position-relative text-center">
                            <a class="shop__collection--link" href="shop.html">
                                <img class="shop__collection--img m-0" src="assets/img/collection/collection8.webp" alt="icon-img">
                                <h3 class="shop__collection--title__style mb-0">Bracelets</h3>
                            </a>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="shop__collection--card position-relative text-center">
                            <a class="shop__collection--link" href="shop.html">
                                <img class="shop__collection--img m-0" src="assets/img/collection/collection9.webp" alt="icon-img">
                                <h3 class="shop__collection--title__style mb-0">Earrings</h3>
                            </a>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="shop__collection--card position-relative text-center">
                            <a class="shop__collection--link" href="shop.html">
                                <img class="shop__collection--img m-0" src="assets/img/collection/collection10.webp" alt="icon-img">
                                <h3 class="shop__collection--title__style mb-0">Wedding-bridal</h3>
                            </a>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="shop__collection--card position-relative text-center">
                            <a class="shop__collection--link" href="shop.html">
                                <img class="shop__collection--img m-0" src="assets/img/collection/collection11.webp" alt="icon-img">
                                <h3 class="shop__collection--title__style mb-0">Shop Earrings</h3>
                            </a>
                        </div>
                    </div>
                    <div class="swiper-slide">
    ...
    <section class="grid__banner--section section--padding pt-0">
        <div class="container">
            <div class="row row_sm_u_reverse align-items-center">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="grid__banner--content">
                        <h2 class="grid__banner--title">Make the connection</h2>
                        <p class="grid__banner--desc">Brighten up your look with vibrant gemstone jewelry.</p>
                        <a class="grid__banner--btn primary__btn" href="shop.html">SHOP NOW</a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="grid__banner--thumbnail position-relative">
                        <img src="assets/img/banner/banner23.webp" alt="banner-img">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5 col-md-5">
                        <div class="banner__fullwidth--thumbnail">
                            <img src="assets/img/banner/banner24.webp" alt="img">
                        </div>
                    </div>
                    <div class="col-lg-7 col-md-7">
                        <div class="banner__fullwidth--content">
                            <h3 class="banner__fullwidth--content__subtitle">SPECIAL OFFER</h3>
                            <h2 class="banner__fullwidth--content__title">These are sure to fit in perfectly with your style</h2>
                            <h3 class="banner__fullwidth--content__subtitle mb-25">Get Up to 30 % off</h3>
                        ...
                        <article class="blog__card">
                            <div class="blog__card--thumbnail">
                                <a class="blog__card--thumbnail__link" href="blog-details.html">
                                    <img class="blog__card--thumbnail__img" src="assets/img/blog/blog4.webp" alt="blog-img">
                                </a>
                            </div>
                            <div class="blog__card--content blog__sticky--content">
                                ...
                                <h3 class="blog__card--title"><a href="blog-details.html">Cumque nam tenetur error aliquam autem placeat ratione aut!</a></h3>
                    ...
                    <div class="col-lg-4">
                        <div class="blog__card--sidebar">
                            <article class="blog__card mb-30">
                                <div class="blog__card--thumbnail">
                                    <a class="blog__card--thumbnail__link" href="blog-details.html">
                                        <img class="blog__card--thumbnail__img" src="assets/img/blog/blog5.webp" alt="blog-img">
                                    </a>
                                </div>
                                <div class="blog__card--content">
                                    ...
                                    <h3 class="blog__card--title"><a href="blog-details.html">Ad esse soluta, is unde totam odio.</a></h3>
                                    <a class="blog__card--link" href="blog-details.html">Read More</a>
                                </div>
                            </article>
                            <article class="blog__card">
                                <div class="blog__card--thumbnail">
                                    <a class="blog__card--thumbnail__link" href="blog-details.html">
                                        <img class="blog__card--thumbnail__img" src="assets/img/blog/blog6.webp" alt="blog-img">
                                    </a>
                                </div>
                                <div class="blog__card--content">
                                    <div class="blog__meta">
                                    ...
                                    <h3 class="blog__card--title"><a href="blog-details.html">Hypoallergenic Wedding Bands</a></h3>
                                    <a class="blog__card--link" href="blog-details.html">Read More</a>
                                </div>
                            </article>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial__box">
                            <div class="testimonial__box--thumbnail">
                                <img src="assets/img/other/testimonial5.webp" alt="testimonial-img">
                            </div>
