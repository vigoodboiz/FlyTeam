                                        ...
                                        <td class="cart__table--body__list">
                                            <div class="product__image two  d-flex align-items-center">
                                                <div class="product__thumbnail border-radius-5">
                                                    <a class="display-block" href="product-details.html"><img class="display-block border-radius-5" src="{{ asset('upload/public/images/' . $cart->product->image) }}" alt="cart-product"></a>

                                                </div>
                                                <div class="product__description">
                                                    <label>Name</label>
                                                    <h4 class="product__description--name"><a href="product-details.html">{{ $cart->product->name }}</a>
                                                    </h4>
                        ...
                        <div class="payment__history mb-30">
                            ...
                            <ul class="payment__history--inner d-flex">
                                ...
                                <form action="{{ route('vnpay_payment') }}" method="POST">
                                    ...
                                    <li class="payment__history--list"><button class="payment__history--link primary__btn" type="submit" name="redirect" style="margin-right: 10px">VnPay</button>
                                    </li>
                                ...
                                <form action="" method="POST">
                                    @csrf
                                    <li class="payment__history--list"><button class="payment__history--link primary__btn" type="submit">Paypal</button>
                                    </li>
                                </form>
                            </ul>
                        </div>
