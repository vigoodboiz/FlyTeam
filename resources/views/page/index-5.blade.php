...
<main class="main__content_wrapper">
        ...
        <div class="hero__slider--activation swiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="home__five--slider__items">
                        <div class="container">
                            <div class="row">
                        ...
                        <div class="hero__slider--layer style3">
                            <img class="slider__layer--img" src="assets/img/slider/home5-slider1-layer.png" alt="slider-img">
                        </div>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="home__five--slider__items">
                        ...
                        <div class="hero__slider--layer style3">
                            <img class="slider__layer--img" src="assets/img/slider/home5-slider2-layer.png" alt="slider-img">
                        </div>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="home__five--slider__items">
                        ...
                        <div class="hero__slider--layer style3">
                            <img class="slider__layer--img" src="assets/img/slider/home5-slider3-layer.png" alt="slider-img">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Start about section -->
    <section class="about__Section mb-30">
        <div class="container">
            ...
            <div class="row row_sm_u_reverse align-items-center">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="about__content">
                        <h2 class="about__content--title">We have the princess cuts to rule them all</h2>
                        <p class="about__content--desc">Ehuese marws dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis.</p>
                        <a class="about__conten--btn primary__btn" href="about.html">VIEW MORE</a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="about__thumbnail position-relative">
                        <img src="assets/img/other/about2.webp" alt="img">
                ...
                <div class="row mb--n30">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                        <article class="product__card">
                            <div class="product__card--thumbnail">
                                <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                    <img class="product__card--thumbnail__img product__primary--img" src="assets/img/product/main-product/product11.webp" alt="product-img">
                                    <img class="product__card--thumbnail__img product__secondary--img" src="assets/img/product/main-product/product12.webp" alt="product-img">
                                </a>
                                <ul class="product__card--action">
                                    <li class="product__card--action__list">
                                        <a class="product__card--action__btn" title="Quick View" data-bs-toggle="modal" data-bs-target="#examplemodal" href="javascript:void(0)">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                        <article class="product__card">
                            <div class="product__card--thumbnail">
                                <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                    <img class="product__card--thumbnail__img product__primary--img" src="assets/img/product/main-product/product13.webp" alt="product-img">
                                    <img class="product__card--thumbnail__img product__secondary--img" src="assets/img/product/main-product/product14.webp" alt="product-img">
                                </a>
                                <span class="product__badge">-14%</span>
                                <ul class="product__card--action">
                                    <li class="product__card--action__list">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                        <article class="product__card">
                            <div class="product__card--thumbnail">
                                <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                    <img class="product__card--thumbnail__img product__primary--img" src="assets/img/product/main-product/product15.webp" alt="product-img">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                        <article class="product__card">
                            <div class="product__card--thumbnail">
                                <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                    <img class="product__card--thumbnail__img product__primary--img" src="assets/img/product/main-product/product16.webp" alt="product-img">
                                    <img class="product__card--thumbnail__img product__secondary--img" src="assets/img/product/main-product/product15.webp" alt="product-img">
                                </a>
                                <ul class="product__card--action">
                                    <li class="product__card--action__list">
                                        <a class="product__card--action__btn" title="Quick View" data-bs-toggle="modal" data-bs-target="#examplemodal" href="javascript:void(0)">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                        <article class="product__card">
                            <div class="product__card--thumbnail">
                                <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                    <img class="product__card--thumbnail__img product__primary--img" src="assets/img/product/main-product/product14.webp" alt="product-img">
                                    <img class="product__card--thumbnail__img product__secondary--img" src="assets/img/product/main-product/product13.webp" alt="product-img">
                                </a>
                                <span class="product__badge">-14%</span>
                                <ul class="product__card--action">
                                    <li class="product__card--action__list">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                        <article class="product__card">
                            <div class="product__card--thumbnail">
                                <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                    <img class="product__card--thumbnail__img product__primary--img" src="assets/img/product/main-product/product12.webp" alt="product-img">
                                    <img class="product__card--thumbnail__img product__secondary--img" src="assets/img/product/main-product/product11.webp" alt="product-img">
                                </a>
                                <span class="product__badge">-14%</span>
                                <ul class="product__card--action">
                                    <li class="product__card--action__list">
    ...
    <!-- Start collection banner section -->
    <section class="collection__banner--section section--padding pt-0">
        <div class="collection__banner--box position-relative">
            <img class="collection__banner--thumbnail height_583 border-radius-5" src="assets/img/banner/banner-fullwidth7.webp" alt="banner">
            <div class="collection__banner--content text-center">
                <h3 class="collection__banner--subtitle mb-20">GRAND OPENING</h3>
                <h2 class="collection__banner--title mb-30">SUMMER COLLECTIONS</h2>
                <p class="collection__banner--desc mb-35">Ehuese marws dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore <br> et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida.
                </p>
                <a class="collection__banner--btn primary__btn" href="shop.html">SHOP NOW</a>
            </div>
        </div>
    </section>
    <!-- End collection banner section -->
    ...
    <section class="banner__section section--padding pt-0">
        <div class="container">
            <div class="row mb--n30">
                <div class="col-lg-6 banner_col_left_47 col-md-6 mb-30">
                    <div class="banner__box--left__sidebar">
                        <div class="banner__box border-radius-5 position-relative mb-30">
                            <a class="display-block" href="shop.html"><img class="banner__box--thumbnail banner_sm_height-250 border-radius-5" src="assets/img/banner/banner25.webp" alt="banner-img">
                                <div class="banner__box--content__style right__side middle">
                                    <h3 class="banner__box--content__style--subtitle">Store Beautlux</h3>
                                    <h2 class="banner__box--content__style--title ">Rings <br>
                                        Collections</h2>
                                    <span class="banner__box--content__style--btn primary__btn">SHOP NOW </span>
                                </div>
                            </a>
                        </div>
                        <div class="banner__box border-radius-5 position-relative">
                            <a class="display-block" href="shop.html"><img class="banner__box--thumbnail banner_sm_height-250 border-radius-5" src="assets/img/banner/banner26.webp" alt="banner-img">
                                <div class="banner__box--content__style middle">
                                    <h3 class="banner__box--content__style--subtitle">Store Beautlux</h3>
                                    <h2 class="banner__box--content__style--title ">Soak up <br> the savings</h2>
                                    <span class="banner__box--content__style--btn primary__btn">SHOP NOW </span>
                                </div>
                            </a>
                        </div>
                ...
                <div class="col-lg-6 banner_col_right_52 col-md-6 mb-30">
                    <div class="banner__box border-radius-5 position-relative">
                        <a class="display-block" href="shop.html"><img class="banner__box--thumbnail border-radius-5" src="assets/img/banner/banner27.webp" alt="banner-img">
                            <div class="banner__box--content__style top">
                                <h3 class="banner__box--content__style--subtitle">Flat 30% Off On Fruits</h3>
                                <h2 class="banner__box--content__style--title ">Pearlescent blossom <br>
                                    bridal hair pin</h2>
                                <span class="banner__box--content__style--btn primary__btn">SHOP NOW </span>
                            </div>
                        </a>
        ...
        <div class="container">
            <div class="row mb--n30">
                        ...
                        <div class="small__product--step__inner">
                            <article class="small__product--card d-flex align-items-center">
                                <div class="small__product--thumbnail">
                                    <a class="display-block" href="#"><img class="small__product--thumbnail__img" src="assets/img/product/small-product/product1.webp" alt="img"></a>
                                </div>
                                <div class="small__product--content">
                                    ...
                                    <div class="product__card--price">
                                        <span class="current__price">$255.52</span>
                                        <span class="old__price"> $335.00</span>
                                    </div>
                                </div>
                            </article>
                            <article class="small__product--card d-flex align-items-center">
                                <div class="small__product--thumbnail">
                                    <a class="display-block" href="#"><img class="small__product--thumbnail__img" src="assets/img/product/small-product/product2.webp" alt="img"></a>
                                </div>
                                <div class="small__product--content">
                                    <h3 class="product__card--title"><a href="product-details.html">Lorem ipsum dolo sit ame elit. </a></h3>
                                    <ul class="rating product__card--rating d-flex">
                                        <li class="rating__list">
                                            <span class="rating__icon">
                                                <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <article class="small__product--card d-flex align-items-center">
                                <div class="small__product--thumbnail">
                                    <a class="display-block" href="#"><img class="small__product--thumbnail__img" src="assets/img/product/small-product/product3.webp" alt="img"></a>
                                </div>
                                <div class="small__product--content">
                                    <h3 class="product__card--title"><a href="product-details.html">Cotur cing elit Doloqu beatae. </a></h3>
                                    <ul class="rating product__card--rating d-flex">
                                        <li class="rating__list">
                                            <span class="rating__icon">
                                                <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="product__card--price">
                                        <span class="current__price">$260.52</span>
                                        <span class="old__price"> $320.00</span>
                                    </div>
                                </div>
                            </article>
                ...
                <div class="col-lg-4 col-md-6 mb-30">
                    <div class="small__product--step">
                        ...
                        <div class="small__product--step__inner">
                            <article class="small__product--card d-flex align-items-center">
                                <div class="small__product--thumbnail">
                                    <a class="display-block" href="#"><img class="small__product--thumbnail__img" src="assets/img/product/small-product/product4.webp" alt="img"></a>
                                </div>
                                <div class="small__product--content">
                                    <h3 class="product__card--title"><a href="product-details.html">Quis nihil modi dn venia ac? </a></h3>
                                    <ul class="rating product__card--rating d-flex">
                                        <li class="rating__list">
                                            <span class="rating__icon">
                                                <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="product__card--price">
                                        <span class="current__price">$180.52</span>
                                        <span class="old__price"> $225.00</span>
                                    </div>
                                </div>
                            </article>
                            <article class="small__product--card d-flex align-items-center">
                                <div class="small__product--thumbnail">
                                    <a class="display-block" href="#"><img class="small__product--thumbnail__img" src="assets/img/product/small-product/product5.webp" alt="img"></a>
                                </div>
                                <div class="small__product--content">
                                    <h3 class="product__card--title"><a href="product-details.html">Unde quaer minus ipsa excei. </a></h3>
                                    <ul class="rating product__card--rating d-flex">
                                        <li class="rating__list">
                                            <span class="rating__icon">
                                                <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="product__card--price">
                                        <span class="current__price">$215.52</span>
                                        <span class="old__price"> $325.00</span>
                                    </div>
                                </div>
                            </article>
                            <article class="small__product--card d-flex align-items-center">
                                <div class="small__product--thumbnail">
                                    <a class="display-block" href="#"><img class="small__product--thumbnail__img" src="assets/img/product/small-product/product6.webp" alt="img"></a>
                                </div>
                                <div class="small__product--content">
                                    <h3 class="product__card--title"><a href="product-details.html">Alias facilis ut na beatae.</a></h3>
                                    <ul class="rating product__card--rating d-flex">
                                        <li class="rating__list">
                                            <span class="rating__icon">
                                                <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="product__card--price">
                                        <span class="current__price">$290.52</span>
                                        <span class="old__price"> $370.00</span>
                                    </div>
                                </div>
                            </article>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-30">
                    <div class="small__product--step">
                        <div class="section__heading mb-30">
                            <h2 class="section__heading--maintitle">Top Products</h2>
                        </div>
                        <div class="small__product--step__inner">
                            <article class="small__product--card d-flex align-items-center">
                                <div class="small__product--thumbnail">
                            ...
                            <article class="small__product--card d-flex align-items-center">
                                ...
                                <div class="small__product--content">
                                    ...
                                    <div class="product__card--price">
                                        <span class="current__price">$280.52</span>
                                        <span class="old__price"> $380.00</span>
                                    </div>
                                </div>
                            </article>
                            <article class="small__product--card d-flex align-items-center">
    ...
    <div class="lookbook__banner--section">
        <div class="lookbook__banner--inner d-flex">
            <div class="lookbook__thumbnail position-relative">
                <img src="assets/img/banner/banner28.webp" alt="banner">
                <div class="lookbook__box one">
                    <span class="lookbook__box--icon"></span>
                    <div class="lookbook__product one d-flex align-items-center">
                        <div class="lookbook__product--thumbnail">
                            <a class="display-block" href="product-details.html"><img class="lookbook__product--thumbnail__img" src="assets/img/product/small-product/product3.webp" alt="img"></a>
                        </div>
                        <div class="lookbook__product--content">
                            <h3 class="lookbook__product--content__title"><a href="product-details.html">Z 7-8mm Freshwater</a></h3>
                            <div class="product__card--price">
                                <span class="current__price">$260.52</span>
                                <span class="old__price"> $320.00</span>
                            </div>
                            <a class="lookbook__product--link" href="product-details.html">View Product</a>
                        </div>
                    </div>
                </div>
                <div class="lookbook__box two">
                    <span class="lookbook__box--icon"></span>
                    <div class="lookbook__product two d-flex align-items-center">
                        <div class="lookbook__product--thumbnail">
                            <a class="display-block" href="product-details.html"><img class="lookbook__product--thumbnail__img" src="assets/img/product/small-product/product2.webp" alt="img"></a>
                        </div>
                        <div class="lookbook__product--content">
                            <h3 class="lookbook__product--content__title"><a href="product-details.html">Z 7-8mm Freshwater</a></h3>
                            <div class="product__card--price">
                ...
                <div class="lookbook__box three">
                    <span class="lookbook__box--icon"></span>
                    <div class="lookbook__product one d-flex align-items-center">
                        <div class="lookbook__product--thumbnail">
                            <a class="display-block" href="product-details.html"><img class="lookbook__product--thumbnail__img" src="assets/img/product/small-product/product4.webp" alt="img"></a>
                        </div>
                        <div class="lookbook__product--content">
                            <h3 class="lookbook__product--content__title"><a href="product-details.html">Z 7-8mm Freshwater</a></h3>
                            <div class="product__card--price">
