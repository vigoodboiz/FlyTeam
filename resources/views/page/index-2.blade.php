...
@section('content')
    ...
    <main class="main__content_wrapper">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="slider__content">
                                                <h2 class="slider__maintitle text__primary h1">Beauty is Whatever <br>
                                                    Brings Perfect</h2>
                                                <p class="slider__desc">50% OFF on the most popular cosmetic brands.
            ...
            <div class="container">
                <div class="row mb--n30">
                    <div class="col-lg-6 col-md-6 mb-30">
                        <div class="banner__box border-radius-5 position-relative">
                            <a class="display-block" href="shop.html"><img
                                    class="banner__box--thumbnail border-radius-5" src="assets/img/banner/banner9.webp"
                                    alt="banner-img">
                                <div class="banner__box--content">
                                    <h2 class="banner__box--content__title ">Cosmetic Cream Packs</h2>
                    ...
                    <div class="col-lg-6 col-md-6 mb-30">
                        <div class="banner__box border-radius-5 position-relative">
                            <a class="display-block" href="shop.html"><img
                                    class="banner__box--thumbnail border-radius-5" src="assets/img/banner/banner10.webp"
                                    alt="banner-img">
                                <div class="banner__box--content">
        ...
        <section class="advice__banner--section">
            <div class="container">
                <div class="advice__banner--box position-relative">
                    <img class="advice__banner--thumbnail height_225 border-radius-5"
                        src="assets/img/banner/banner11.webp" alt="banner">
                    <div class="advice__banner--content banner__flex d-flex align-items-center">
                        <div class="advice__banner--content__left">
                            <h2 class="advice__banner--title">Flat 50% Off On Fresh Organic</h2>
                            <p class="advice__banner--desc">50% OFF on the most popular cosmetic brands. Order all
                                classy products today!
                            </p>
                        </div>
                        <a class="advice__banner--btn primary__btn" href="shop.html">SHOP NOW</a>
                    </div>
                    <img class="advice__banner--layer__img" src="assets/img/banner/banner-layer1.webp" alt="img">
                </div>
            </div>
        </section>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                            <article class="product__card">
                                ...
                                <div class="product__card--content text-center">
                                    ...
                                    <h3 class="product__card--title"><a href="product-details.html">Z 7-8mm Freshw
                                            Button Pearl </a></h3>
                                    <div class="product__card--price">
                                        <span class="current__price">$239.52</span>
                                        <span class="old__price"> $362.00</span>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                            <article class="product__card">
                                ...
                                <div class="product__card--content text-center">
                                    ...
                                    <h3 class="product__card--title"><a href="product-details.html">Sed impedit autem
                                            min ver velit?</a></h3>
                                    <div class="product__card--price">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                            <article class="product__card">
                                ...
                                <div class="product__card--content text-center">
                                    ...
                                    <h3 class="product__card--title"><a href="product-details.html">Alias facilis ut
                                            natus beatae. </a></h3>
                                    <div class="product__card--price">
                                        <span class="current__price">$239.52</span>
                                        <span class="old__price"> $362.00</span>
            ...
            <div class="banner__fullwidth--inner">
                <div class="container">
                    <div class="row row_sm_reverse align-items-center">
                        <div class="col-lg-6 col-md-6">
                            <div class="banner__fullwidth--content padding__right">
                                ...
                                <p class="banner__fullwidth--content__desc">We are committed to offering the finest
                                    selection of clean and natural skin care products created by the world’s leading
                                    brands that are pioneers in innovation, science, technology, and sustainability.</p>
        ...
        <section class="video__section section--padding pt-0">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6">
                        <div class="video__banner--box width_100 position-relative">
                            <img class="video__box--thumbnail" src="assets/img/banner/banner12.webp" alt="banner-img">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="video__box--content">
                            <h2 class="video__box--content__title">In Clean Beauty List</h2>
                            <p class="video__box--content__desc">Discover our Bestseller Edit, the best products to
                                restart and refresh your skincare and beauty routine.</p>
                            <a class="video__box--content__btn primary__btn" href="shop.html">SHOP NOW</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <article class="blog__card">
                                <div class="blog__card--thumbnail">
                                    <a class="blog__card--thumbnail__link" href="blog-details.html">
                                        <img class="blog__card--thumbnail__img" src="assets/img/blog/blog1.webp"
                                            alt="blog-img">
                                    </a>
                                </div>
                                <div class="blog__card--content">
                                    ...
                                    <h3 class="blog__card--title"><a href="blog-details.html">Justo Pellentesque Donec
                                            lobortis faucibus Vestibulum</a></h3>
                        ...
                        <div class="swiper-slide">
                            <article class="blog__card">
                                <div class="blog__card--thumbnail">
                                    <a class="blog__card--thumbnail__link" href="blog-details.html">
                                        <img class="blog__card--thumbnail__img" src="assets/img/blog/blog2.webp"
                                            alt="blog-img">
                                    </a>
                                </div>
                                <div class="blog__card--content">
                                    ...
                                    <h3 class="blog__card--title"><a href="blog-details.html">Lorem ipsum dolor sit,
                                            amet adipisici elit. aliquam.</a></h3>
                                    <a class="blog__card--link" href="blog-details.html">Read More</a>
                                </div>
                            </article>
                        </div>
                        <div class="swiper-slide">
                            <article class="blog__card">
                                <div class="blog__card--thumbnail">
                                    <a class="blog__card--thumbnail__link" href="blog-details.html">
                                        <img class="blog__card--thumbnail__img" src="assets/img/blog/blog3.webp"
                                            alt="blog-img">
                                    </a>
                                </div>
                                <div class="blog__card--content">
                                    ...
                                    <h3 class="blog__card--title"><a href="blog-details.html">Numquam nulla ducimus
                                            neque, officiis perfere vol!</a></h3>
                                    <a class="blog__card--link" href="blog-details.html">Read More</a>
                                </div>
                            </article>
                        </div>
        ...
        <section class="instagram__section section--padding">
            <div class="container">
                <div class="section__heading text-center mb-40">
                    <h2 class="section__heading--maintitle">Follow <span class="text__secondary">@BeautLux</span> on
                        instagram</h2>
                </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position-relative">
                                <a class="instagram__thumbnail--link" target="_blank"
                                    href="https://www.instagram.com/p/CZkF3TLBTT7">
                                    <img class="instagram__thumbnail--img" src="assets/img/other/instagram1.webp"
                                        alt="">
                        ...
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position-relative">
                                <a class="instagram__thumbnail--link" target="_blank"
                                    href="https://www.instagram.com/p/CZkF3TLBTT7">
                                    <img class="instagram__thumbnail--img" src="assets/img/other/instagram2.webp"
                                        alt="">
                                    <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199"
                                            viewBox="0 0 25.198 25.199">
                        ...
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position-relative">
                                <a class="instagram__thumbnail--link" target="_blank"
                                    href="https://www.instagram.com/p/CZkF3TLBTT7">
                                    <img class="instagram__thumbnail--img" src="assets/img/other/instagram3.webp"
                                        alt="">
                                    <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199"
                                            viewBox="0 0 25.198 25.199">
                        ...
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position-relative">
                                <a class="instagram__thumbnail--link" target="_blank"
                                    href="https://www.instagram.com/p/CZkF3TLBTT7">
                                    <img class="instagram__thumbnail--img" src="assets/img/other/instagram4.webp"
                                        alt="">
                                    <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199"
                                            viewBox="0 0 25.198 25.199">
                        ...
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position-relative">
                                <a class="instagram__thumbnail--link" target="_blank"
                                    href="https://www.instagram.com/p/CZkF3TLBTT7">
                                    <img class="instagram__thumbnail--img" src="assets/img/other/instagram5.webp"
                                        alt="">
                                    <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199"
                                            viewBox="0 0 25.198 25.199">
