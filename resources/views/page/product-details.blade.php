                ...
                <div class="product__section--inner product__swiper--column4 padding swiper">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            ...
                            <form action="{{route('addCart',$pro_same->id)}}" method="POST">
                            @csrf()
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                        <img class="product__card--thumbnail__img product__primary--img" src="{{ asset('storage/images/'.$pro_same->image) }}" alt="product-img">
