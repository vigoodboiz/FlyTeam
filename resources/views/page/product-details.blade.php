                                            ...
                                            <div class="swiper-slide">
                                                <div class="product__media--preview__items">
                                                    <a class="product__media--preview__items--link glightbox"
                                                        ...
                                                        href="{{ asset('upload/public/images/' . $pro_dt->image) }}"><img
                                                            class="product__media--preview__items--img"
                                                            src="{{ asset('upload/public/images/' . $pro_dt->image) }}"
                                                            style="height: 400px;" alt="product-media-img"></a>
                                                    <div class="product__media--view__icon">
                                                        <a class="product__media--view__icon--link glightbox"
                                                            href="{{ asset('upload/public/images/' . $pro_dt->image) }}"
                                                            data-gallery="product-media-preview">
                                    ...
                                    <form action="#">
                                                        ...
                                                        <div class="variant__color--list">
                                                            ...
                                                            <label class="variant__color--value red" for="color-red5"
                                                                title="Red"><img class="variant__color--value__img"
                                                                    src="{{ asset('becute/assets/img/product/small-product/product1.webp') }}"
                                                        ...
                                                        <div class="variant__color--list">
                                                            ...
                                                            <label class="variant__color--value red" for="color-red6"
                                                                title="Black"><img class="variant__color--value__img"
                                                                    src="{{ asset('becute/assets/img/product/small-product/product2.webp') }}"
                                                                    alt="variant-color-img"></label>
                                                        </div>
                                                        <div class="variant__color--list">
                                                            ...
                                                            <label class="variant__color--value red" for="color-red7"
                                                                title="Pink"><img class="variant__color--value__img"
                                                                    src="{{ asset('becute/assets/img/product/small-product/product3.webp') }}"
                                                                    alt="variant-color-img"></label>
                                                        </div>
                                                        <div class="variant__color--list">
                                                            ...
                                                            <label class="variant__color--value red" for="color-red8"
                                                                title="Orange"><img class="variant__color--value__img"
                                                                    src="{{ asset('becute/assets/img/product/small-product/product4.webp') }}"
                                                                    alt="variant-color-img"></label>
                                                        </div>
                                                    </div>
                                                </fieldset>
                                                ...
                                                <fieldset class="variant__input--fieldset">
                                                    ...
                                                    <ul class="variant__size d-flex">
                                                        <li class="variant__size--list">
                                                            ...
                                                            <label class="variant__size--value red" for="weight4">5
                                                                kg</label>
                                                        </li>
                                                        <li class="variant__size--list">
                                                            <input id="weight5" name="weight" type="radio">
                                                            <label class="variant__size--value red" for="weight5">3
                                                                kg</label>
                                                        </li>
                                                        <li class="variant__size--list">
                                                            <input id="weight6" name="weight" type="radio">
                                                            <label class="variant__size--value red" for="weight6">2
                                                                kg</label>
                                                        </li>
                                                    </ul>
                                                </fieldset>
                                        ...
                                        <div class="guarantee__safe--checkout mb-30">
                                            ...
                                            <img class="guarantee__safe--checkout__img"
                                                src="{{ asset('becute/assets/img/other/safe-checkout.webp') }}"
                                                alt="Payment Image">
                                        </div>
                                                ...
                                                <details>
                                                    ...
                                                    <div class="product__details--summary__wrapper">
                                                        <div class="product__tab--content">
                                                            ...
                                                            <div
                                                                class="image__with--text__percent product__tab--percent__style mb-25">
                                                                <ul>
                                                                    <li class="image__with--text__percent--list mb-20">
                                                                        <span
                                                                            ...
                                                                            <span
                                                                                ...
                                                                                control</span>
                                                                            <span
                                                                                class="image__with--text__percent--content">58%</span>
                                                                        </span>
                                                                    </li>
                                                                    <li class="image__with--text__percent--list two mb-20">
                                                                        <span
                                                                            class="image__with--text__percent--top d-flex justify-content-between align-content-center">
                                                                            <span
                                                                                class="image__with--text__percent--content">Design
                                                                                Device</span>
                                                                            <span
                                                                                class="image__with--text__percent--content">77%</span>
                                                                        </span>
                                                                    </li>
                                                                    <li
                                                                        class="image__with--text__percent--list three mb-20">
                                                                        <span
                                                                            class="image__with--text__percent--top d-flex justify-content-between align-content-center">
                                                                            <span
                                                                                class="image__with--text__percent--content">Service
                                                                                Control</span>
                                                                            <span
                                                                                class="image__with--text__percent--content">58%</span>
                                                                        </span>
                                                                    ...
                                                                    <li class="image__with--text__percent--list four">
                                                                        <span
                                                                            class="image__with--text__percent--top d-flex justify-content-between align-content-center">
                                                                            <span
                                                                                class="image__with--text__percent--content">Metar
                                                                                Surusn</span>
                                                                            <span
                                                                                class="image__with--text__percent--content">69%</span>
                                                                        </span>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                            <div class="product__tab--content__step">
                                                                <p class="product__tab--content__desc">Polor sit amet,
                                                                    consectetuer adipiscing elit. Morbi commodo, ipsum sed
                                                                    pharetra gravida, orci magna rhoncus neque, id pulvinar
                                                                    odio
                                                    ...
                                                    <div class="product__details--summary__wrapper">
                                                        <div class="product__reviews">
                                                                ...
                                                                <div class="reviews__comment--list d-flex">
                                                                    ...
                                                                    <div class="reviews__comment--content">
                                                                        <div
                                                                            ...
                                                                            <span
                                                                                class="reviews__comment--content__date">May
                                                                                26, 202</span>
                                                                        </div>
                                                                        <p class="reviews__comment--content__desc">Lorem
                                                                            ipsum, dolor sit amet consectetur adipisicing
                                                                            elit. Eos ex repellat officiis neque.</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div id="writereview" class="reviews__comment--reply__area">
                                                                ...
                                                                <button class="primary__btn text-white"
                                                    ...
                                                    <div class="product__details--summary__wrapper">
                                                        <ul class="additional__info_list">
                                                            <li class="additional__info_list--item">
                                                                <span
                                                                    class="info__list--item-head"><strong>Color</strong></span>
                                                                <span class="info__list--item-content">Black, white, blue,
                                                                    red, gray</span>
                                                            </li>
                                                            <li class="additional__info_list--item">
                                                                <span
                                                                    class="info__list--item-head"><strong>Weight</strong></span>
                                                                <span class="info__list--item-content">2kg</span>
                                                            </li>
                                                            <li class="additional__info_list--item">
                                                                <span
                                                                    class="info__list--item-head"><strong>Brand</strong></span>
                                                            ...
                                                            <li class="additional__info_list--item">
                                                                <span
                                                                    class="info__list--item-head"><strong>Battery</strong></span>
                                ...
                                <article class="product__card">
                                    <div class="product__card--thumbnail">
                                        <a class="product__card--thumbnail__link display-block"
                                            href="{{ route('shopDetails', $pro_same->id) }}">
                                            <img class="product__card--thumbnail__img product__primary--img"
                                                src="{{ asset('upload/public/images/' . $pro_same->image) }}"
                                                style="height: 180px;" alt="product-img">
