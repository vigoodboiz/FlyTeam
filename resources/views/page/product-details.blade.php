                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset('storage/images/'.$pro_dt->image) }}"><img class="product__media--preview__items--img" src="{{ asset('storage/images/'.$pro_dt->image) }}" style="height: 400px;" alt="product-media-img"></a>
                                        <div class="product__media--view__icon">
                                            <a class="product__media--view__icon--link glightbox" href="{{ asset('storage/images/'.$pro_dt->image) }}" data-gallery="product-media-preview">
                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset('storage/images/'.$pro_dt->image) }}"><img class="product__media--preview__items--img" src="{{ asset('storage/images/'.$pro_dt->image) }}" alt="product-media-img"></a>
                                        <div class="product__media--view__icon">
                                            <a class="product__media--view__icon--link glightbox" href="{{ asset('storage/images/'.$pro_dt->image) }}" data-gallery="product-media-preview">
                                                <svg class="product__items--action__btn--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512">
                                                    <path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img" src="{{ asset('storage/images/'.$pro_dt->image) }}" alt="product-nav-img">
                                    </div>
                                </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details--info">
                            ...
                            <div class="product__details--info__price mb-12">
                                ...
                                <span class="current__price">${{$pro_dt->price_sale}}</span>
                                <span class="old__price">${{$pro_dt->price}}</span>
                                @else
                                <span class="current__price">${{$pro_dt->price}}</span>
                                @endif
                            </div>
                                    ...
                                    <fieldset class="variant__input--fieldset">
                                        ...
                                        <div class="variant__color d-flex">
                                            <div class="variant__color--list">
                                                ...
                                                <label class="variant__color--value red" for="color-red5" title="Red"><img class="variant__color--value__img" src="{{asset('becute/assets/img/product/small-product/product1.webp')}}" alt="variant-color-img"></label>
                                            </div>
                                            <div class="variant__color--list">
                                                <input id="color-red6" name="color" type="radio">
                                                <label class="variant__color--value red" for="color-red6" title="Black"><img class="variant__color--value__img" src="{{asset('becute/assets/img/product/small-product/product2.webp')}}" alt="variant-color-img"></label>
                                            </div>
                                            <div class="variant__color--list">
                                                <input id="color-red7" name="color" type="radio">
                                                <label class="variant__color--value red" for="color-red7" title="Pink"><img class="variant__color--value__img" src="{{asset('becute/assets/img/product/small-product/product3.webp')}}" alt="variant-color-img"></label>
                                            </div>
                                            <div class="variant__color--list">
                                                <input id="color-red8" name="color" type="radio">
                                                <label class="variant__color--value red" for="color-red8" title="Orange"><img class="variant__color--value__img" src="{{asset('becute/assets/img/product/small-product/product4.webp')}}" alt="variant-color-img"></label>
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
                                                ...
                                                <div class="reviews__comment--area">
                                                    <div class="reviews__comment--list d-flex">
                                                        <div class="reviews__comment--thumb">
                                                            <img src="" alt="comment-thumb">
                                                        </div>
                                                        <div class="reviews__comment--content">
                                                            <div class="reviews__comment--top d-flex justify-content-between">
                                                                <div class="reviews__comment--top__left">
                                                                    <h3 class="reviews__comment--content__title h4">{{$cmt->user_name}}</h3>
                                                                </div>
                                                                <span class="reviews__comment--content__date">{{$cmt->date}}</span>
                                                            </div>
                                                                <p class="reviews__comment--content__desc ">{{$cmt->content}}</p>
                                                                <button type="button" class="btn btn-secondary" style="width: 60px; height: 30px"><a href="{{ route('route_comment_update', ['id' => $cmt->id]) }}">Sửa</a></button>
                                                                <button type="button" class="btn btn-danger "style="width: 60px; height: 30px"><a href="{{ route('route_comment_delete_fe', ['id' => $cmt->id]) }}">Xóa</a></button>
                                                        </div>
                                                    </div>
                                                </div>
                                                @endforeach
                        ...
                        <article class="product__card">
                            ...
                            <div class="product__card--content text-center">
                                ...
                                <div class="product__card--price">
                                    ...
                                    <span class="current__price">${{$pro_same->price_sale}}</span>
                                    <span class="old__price">${{$pro_same->price}}</span>
                                    @else
                                    <span class="current__price">${{$pro_same->price}}</span>
                                    @endif
                                </div>
                            </div>
                        </article>
