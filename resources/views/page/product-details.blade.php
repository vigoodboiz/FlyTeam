                                ...
                                <div class="product__details--info">
                                    ...
                                    <div class="product__details--info__price mb-12">
                                        @if (isset($pro_dt->price_sale) && $pro_dt->price_sale > 0)
                                            <span id="price" class="current__price">{{ $pro_dt->price_sale }}đ</span>
                                            <span id="price" class="old__price">{{ $pro_dt->price }}đ</span>
                                        @else
                                            <span id="price" class="current__price">{{ $pro_dt->price }}đ</span>
                                        @endif
                                    </div>
