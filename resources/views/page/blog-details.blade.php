                    ...
                    <div class="blog__details--wrapper">
                        <div class="entry__blog">
                            <div class="blog__post--header mb-30">
                                <h2 class="post__header--title mb-15">We are committed to offering the finest selection of clean and natural skin</h2>
                                <p class="blog__post--meta">Posted by : admin / On : May 26, 2022 / In : <a class="blog__post--meta__link" href="blog-details.html">Company, Image, Travel</a></p>
                            </div>
                            ...
                            <div class="blog__details--content">
                                <h3 class="blog__details--content__subtitle mb-25">5 Best Budget-Friendly Mobiles Under BDT 20K – 30K In Bangladesh (2022)!</h3>
                        ...
                        <div class="related__post--area">
                            <div class="related__post--heading mb-30">
                                <h2 class="related__post--heading__maintitle">Related <span>Articles</span></h2>
                            </div>
                            <div class="row row-cols-md-2 row-cols-sm-2 row-cols-1 mb--n28">
                                <div class="col mb-28">
                                    <div class="related__post--items">
                                        <div class="related__post--thumb border-radius-10 mb-20">
                                            <a class="display-block" href="blog-details.html"><img class="related__post--img display-block border-radius-10" src="assets/img/blog/blog1.webp" alt="related-post"></a>
                                        </div>
                                ...
                                <div class="col mb-28">
                                    <div class="related__post--items">
                                        <div class="related__post--thumb border-radius-10 mb-20">
                                            <a class="display-block" href="blog-details.html"><img class="related__post--img display-block border-radius-10" src="assets/img/blog/blog2.webp" alt="related-post"></a>
                                        </div>
                                        <div class="related__post--text">
                        ...
                        <div class="comment__box">
                            <div class="reviews__comment--area2">
                            ...
                            <div class="reviews__comment--reply__area">
                                <form action="#">
                                    <h3 class="blog__comment--title mb-30">Leave A Comment</h3>
                                    <div class="row">
                                    ...
                                    <button class="blog__comment--btn primary__btn" data-hover="Submit" type="submit">SUBMIT</button>
                                </form>
                            </div>
                        </div>
                    </div>
