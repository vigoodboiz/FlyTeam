            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        ...
                        <li><i class="fa fa-exclamation-triangle"></i><a href="{{ route('products.index') }}">Quản lý sản phẩm</a></li>
                        <li><i class="fa fa-spinner"></i><a href="{{ route('admin.categories.index') }}">Quản lý danh mục</a>
                        </li>
